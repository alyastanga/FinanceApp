...
- Usage: Reference from command with `@/Users/familyaccount/git/FinanceApp/.gemini/get-shit-done/workflows/{name}.md`
...
**get-shit-done/**
- Purpose: Resources installed to /Users/familyaccount/git/FinanceApp/.gemini/
- Source: Copied by bin/install.js during installation
- Committed: Yes (source of truth)

**commands/**
- Purpose: Slash commands installed to /Users/familyaccount/git/FinanceApp/.gemini/commands/
- Source: Copied by bin/install.js during installation
- Committed: Yes (source of truth)
