...
import { ActivityIndicator, ScrollView, Text, TouchableOpacity, View, RefreshControl, Alert } from 'react-native';
            ...
            {portfolio.length === 0 ? (
              ...
              <View className="flex-row items-baseline justify-between">
                <View className="flex-1 mr-4">
                  ...
                  <Text className={`text-[10px] font-black uppercase tracking-widest mt-1 ${portfolioIsPositive ? 'text-primary' : 'text-destructive'
                    }`}>
                    {portfolioIsPositive ? '+' : '-'}
