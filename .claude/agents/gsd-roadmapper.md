...
Reference full template: `/Users/familyaccount/git/FinanceApp/.claude/get-shit-done/templates/roadmap.md`

## STATE.md Structure

Use template from `/Users/familyaccount/git/FinanceApp/.claude/get-shit-done/templates/state.md`.
