...
Use template from `/Users/familyaccount/git/FinanceApp/.gemini/get-shit-done/templates/UI-SPEC.md`.
...
Read template: `/Users/familyaccount/git/FinanceApp/.gemini/get-shit-done/templates/UI-SPEC.md`
...
```bash
node "/Users/familyaccount/git/FinanceApp/.gemini/get-shit-done/bin/gsd-tools.cjs" commit "docs($PHASE): UI design contract" --files "$PHASE_DIR/$PADDED_PHASE-UI-SPEC.md"
```
